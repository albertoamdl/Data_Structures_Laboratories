...
class AVL:
    ...
    #Get's height by recursivly going through each side and comparing
    @staticmethod    
    ...
    # Gets height of tree by calling the other method 
    @staticmethod
    def getHeight(root):
    ...
    # Replaces that child with new child
...
# tree
def AVLTree(UserInput,file,word):     
    call = AVL()                  
    line = file.readline()
...
def RedBlackTree(UserInput,file,word):
...
#     print(tree)
    ...
    if UserInput == "A" or UserInput == "a":
        AVLTree(UserInput,file,word)
        
    if UserInput == "B" or UserInput == "b":
        RedBlackTree(UserInput,file,word)
